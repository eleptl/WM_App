import { StyleSheet, View, Text, StatusBar, TouchableOpacity, Button, BackHandler, Modal } from 'react-native';
...
import EMTabNavigation from '../components/EMTabNavigation.js';


import { LogBox } from 'react-native';
LogBox.ignoreAllLogs(true);
LogBox.ignoreLogs(['TextInput.Icon: Support for defaultProps will be removed from function components']);


console.log('Render EntrataMerci, EMTabNavigation disponibile?', EMTabNavigation);
...
const EntrataMerci = () => {
    ...
    //riconosciumento tabAttuale
    const navigationState = useNavigationState(state => state);
    const currentTabIndex = navigationState.routes[navigationState.index].state?.index ?? 1;

    console.log('qui arriva1');

    let currentTab = 'Order'; // Default tab
