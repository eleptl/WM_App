...
const Products = ({ route }) => {
  ...
  if (route.params.searchTerm != null) {
  ...
  const handleSearch = async (searchTerm) => {
    ...
    // const indexAgg = 'http://192.168.1.9:5000/api/prodotto/maktx/?matnr=' + searchTerm; 
    const indexAgg = 'http://192.168.1.161:5000/api/prodotto/maktx/?matnr=' + searchTerm;
    axios.put(indexAgg)

    // const index = 'http://192.168.1.9:5000/api/prodotto/?matnr=' ; 
    const index = 'http://192.168.1.161:5000/api/prodotto/?matnr=';

    if (!(searchTerm === null)) {
      navigation.navigate('ProductsResult', { username: username, index: index, searchTerm: searchTerm, sourcePage: route.name });
    }
  };
